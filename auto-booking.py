...
class autologin():
    ...
    def setup(self):
        ...
        self.validate_state(self.driver,"//*[@id='divBookingDateSelector']/div[2]/div[2]/button[2]")
        ...
        while True:
            ...
            # time.sleep(1)
            self.validate_state(self.driver, "//button[contains(text(),'Book Now')]")
...
if __name__ == '__main__':
    court = input("Which field you wanna chooose? Please respond in 1, 2, 3? ----- Your answer: ")
